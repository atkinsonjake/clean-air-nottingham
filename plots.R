...
# Data
comparisons <- read.csv('/Users/jakeatkinson/Documents/Personal/clean-air-nottingham/response_data/processed_data_can_sensors.csv')
comparisons <- na.omit(comparisons)
comparisons$sensor_index <- factor(comparisons$sensor_index)

comparisons <- comparisons[comparisons$fields %in% c("pm1.0_atm", "pm2.5_atm", "pm10.0_atm"), ]
